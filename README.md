...
| `5.x`           | `>=7.4`           | `>=5.8`          | Above + Config-based Expiring Objects + Form Post Signature + Prefix     | Deprecated     |
| `6.x`           | `>=7.4`           | `>=7.x`          | PHP 8 support     | Deprecated     |
| `7.x`           | `>=8.1`           | `9.x - 13.x`     | Laravel 9 to 13 support     | Active     |
